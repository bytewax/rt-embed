from bytewax.inputs import StatelessSource, StatefulSource, PartitionedInput, DynamicInput
from bytewax.connectors.files import FileInput, DirInput, CSVInput

class _ImageSource(StatelessSource):
    """Image reader for image inputs.

    Uses cv2 to read the image and can
    handle the following types https://docs.opencv.org/4.x/d4/da8/group__imgcodecs.html#ga288b8b3da0892bd651fce07b3bbd3a56.
